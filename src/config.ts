...
export const NEXT_IMAP_MAIL_SERVER_PORT =
  process.env.NEXT_IMAP_MAIL_SERVER_PORT;
export const NEXT_SMTP_MAIL_SERVER_PORT =
  process.env.NEXT_SMTP_MAIL_SERVER_PORT;
...
export const SESSION_EXPIRES_DAYS =
  Number(process.env.SESSION_EXPIRES_DAYS) || 1;
