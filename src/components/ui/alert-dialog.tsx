...
interface AlertDialogDefaultProps extends LayoutBaseProps, VariantProps<typeof buttonVariants> {
  description: string;
  disabled?: boolean;
  onOk: () => void;
}
...
export const AlertDialogDefault: React.FC<AlertDialogDefaultProps> = ({
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger onClick={(e) => e.stopPropagation()} {...{ disabled }}>
        {children}
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction variant={variant} onClick={onOk}>
            {t('continue')}
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
